...
This article explains how I found a Blind XXE via a version of iText which is vulnerable to CVE-2017-9096 that was been used by a Bug bounty program to handle/extract text and metadata from PDF documents through a file upload feature.


==The scope of this does not includes the definition of XXEs, sorry about that, I'm trying to make this as straightforward as I can, you know, KISS...==
